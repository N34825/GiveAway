...
<head>
	<?= $this->Html->charset() ?>
	<title><?= $this->fetch('title') ?: 'GiveAway' ?></title>

	<!-- Meta tags -->
	<?= $this->Html->meta('viewport', 'width=device-width, initial-scale=1') ?>
	<?= $this->Html->meta('description', 'This is a CakePHP 5 app') ?>
	<?= $this->Html->meta('keywords', 'NO PAIN NO GAIN') ?>
	<?= $this->Html->meta('author', 'Nang Khin Ohn') ?>
	<!-- Mobile Metas -->
		...
		<header class="header_section">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<div class="user_option">
					...
					<?= $this->Html->link('<i class="fa fa-user user-margin" aria-hidden="true"></i> New Member', [
						'controller' => 'Users',
						'action' => 'signup'
					], [
						'class' => 'user-register',
